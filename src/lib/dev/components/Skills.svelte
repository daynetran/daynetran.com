<script>
    ...
    import python from "$lib/images/dev/python.jpg"
    ...
    <ol class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-8 text-lg decoration-4 font-semibold text-stone-900">
        <li class="flex flex-col items-start justify-start gap-y-2">
            ...
            <div class="grid grid-cols-3 gap-x-4 gap-y-2 justify-start group">            
                ...
                <a href="https://www.java.com/en/" title="Java" target="_blank"><img src="{java}" alt="Java" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
                <a href="https://go.dev/" title="Golang" target="_blank"><img src="{golang}" alt="golang" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
        ...
        <li class="flex flex-col items-start gap-y-2">
            ...
            <div class="grid grid-cols-3 gap-x-4 gap-y-2 justify-start group">            
                ...
                <a href="https://react.dev/" title="React" target="_blank"><img src="{react}" alt="react" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
                <a href="https://nextjs.org/" title="Next" target="_blank"><img src="{next}" alt="next" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
                <!-- <a href="https://www.svelte.dev" title="Astro" target="_blank"><img src="{astro}" alt="astro" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a> -->
                <a href="https://www.tailwindcss.com" title="Tailwind" target="_blank"><img src="{tailwind}" alt="tailwind" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
        ...
        <li class="flex flex-col items-start gap-y-2">
            ...
            <div class="grid grid-cols-3 gap-x-4 gap-y-2 justify-start group">            
                ...
                <a href="https://www.medusajs.com" title="Medusa" target="_blank"><img src="{medusa}" alt="medusa" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
                <a href="https://www.contentful.com/" title="Contentful" target="_blank"><img src="{contentful}" alt="contentful" class="w-[45px]  h-[45px]  rounded-lg grayscale group-hover:grayscale-0 transition duration-300 object-cover"></a>
