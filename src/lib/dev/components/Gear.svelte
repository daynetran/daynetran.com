<div class="flex flex-col gap-y-4">
    ...
    <ul style="--stagger:10" data-animate="" class="flex flex-wrap gap-x-2 gap-y-2 text-md font-semibold decoration-4 text-stone-900 dark:text-white">
        <li class="p-2 rounded-md border border-black dark:border-white">
        ...
        <li class="p-2 rounded-md border border-black dark:border-white">
            <a href="https://www.dell.com/en-us/shop/dell-27-4k-uhd-monitor-s2721qs/apd/210-axlg/monitors-monitor-accessories" target="_blank">Dell 4k Monitor</a>     
        </li>
    </ul>
</div>