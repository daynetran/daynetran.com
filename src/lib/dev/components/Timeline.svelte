<div id="timeline" class="relative flex justify-start items-start w-full">
    <div class="">
        <a href="/dev#timeline">
            <h2 id="timeline" style="--stagger:3" data-animate="" class="text-2xl font-bold decoration-4 mb-8 text-stone-900 dark:text-white">
                # timeline
            </h2>
        </a>
        <ol class="flex flex-col dark:border-stone-700">
