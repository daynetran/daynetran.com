...
<section>
    <h1 class="text-3xl font-bold decoration-4 text-stone-900 dark:text-white" style="--stagger:1" data-animate="">dev</h1>
    <br>
    <p style="--stagger:2" data-animate="" class="text-stone-900 dark:text-stone-100">
