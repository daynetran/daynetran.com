    ...
    return (
        <>
            <aside
                className={cn(
                    hasPost,
                    "flex-col gap-3 overflow-y-auto w-screen lg:min-w-80 lg:max-w-80 2xl:min-w-96 2xl:max-w-96 bg-white dark:bg-neutral-900 lg:border-r border-neutral-200 dark:border-neutral-800",
                    zenMode,
                )}>
                {children}
            </aside>
